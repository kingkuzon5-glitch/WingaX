<x-layouts.admin title="Add Category" active="categories">
    <div class="max-w-[32rem] mx-auto w-full">
        <h2 class="font-title-md text-title-md md:font-headline-lg md:text-headline-lg text-on-background mb-md">Add Category</h2>
        ...
        <form method="POST" action="{{ route('admin.categories.store') }}" enctype="multipart/form-data"
            ...
            <div>
                ...
                <input id="name" name="name" type="text" value="{{ old('name') }}" required placeholder="e.g., Electronics"
            ...
            <div>
                <label for="image" class="block font-label-bold text-label-bold text-on-surface-variant mb-2">Image <span class="font-normal">(optional)</span></label>
